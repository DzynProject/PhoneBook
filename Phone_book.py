...
#     - запрос у пользователя нового контакта
#     - открываем файл на дозапись # a
#     - доьавить новый контакта
...
#     - запрос данных ддя поиска
#     - открываем файл на чтение # r
#     - считать данные из файла
# 5. Создать UI:
#     - вывод меню на экран
#     - запрос у пользователя вариант действия
#     - запуск соответствующей функции
#     - осуществить возможность выхода из программы

# 6. Добавить в меню копирование данных из одного файла в другой
